 ...
 <div class="container">
    <div class="row align-items-center form-pos">
        <div class="col-12 col-md-6 text-center py-3">
            ...
            <br>
            <a href="https://ya-hub.com/" class="" style="color: #fd5c29;">
                <i class="fa fa-home fa-2x py-4"></i>
            </a>
        </div>
                ...
                <div class="content">
                    <div class="ya-form text-white px-md-3 pb-3 content-1 active">
                        <div class="text-center my-4 py-2">
                            ...
                            <button type="submit"
                                class="btn bg-white w-100 mt-3 s-btn text-uppercase"> Login 
                            </button>
                            <center>Don't have an account? <a class="register-link" href="https://ya-hub.com/app/register">Click here</a></center>
                        </form>
                    </div>
                </div>
            </div>
