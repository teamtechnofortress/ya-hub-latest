    ...
    <div class="user chat-head px-sm-3 px-1 py-2 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a class="tooltip-link" href="{{url('projects/'.$project->id)}}"
                class="btn bg-white mx-sm-1 py-1" style="text-decoration: none !important;">
                <img src="{{url('uploads/white-barrier.png')}}" alt="" height="30px">
                <!-- <span class="tooltiptext">Project</span> -->
            </a>
            <a class="tooltip-link" onclick="$('.media-toggle').toggle()" href="#0"
                class="btn media-toggle-btn bg-white mx-sm-1 py-1" style="text-decoration: none !important;">
                <img src="{{url('uploads/white-explorer.png')}}" alt="" height="30px">
...
<div class="p-4 chat-box" style="padding-bottom: 3.5rem !important;"> 
   ...
   <div id="message-{{$message->id}}"
        ...
        <div class="s-msg">
            <div class="py-1 px-sm-3 px-1 rounded">@php echo $messageValue @endphp</div>
            <span class="like">👍</span>
            <span class="dislike">👎</span>
            <span class="love reaction">❤️</span>
            <span class="anger reaction">😡</span>
            <span class="laugh reaction">😂</span>
        </div>
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        append(`<div id="message-${message.id}" class="d-flex flex-column justify-content-end text-right">
                                    <div class="s-msg">
                                        <div class="py-1 px-sm-3 px-1 rounded">${message.message}</div>
                                    </div>
                                    <span class="ml-2 time">
                                        <span><a class="edit_msg" href="#0" data-id="${message.id}" style="color: #fc5c29;">Edit <i class="fa fa-edit"></i></a></span>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        `);
                                ...
                                append(`<div id="message-${message.id}" class="d-flex flex-column justify-content-end text-right">
                                        <div class="s-msg">
                                            <div class="py-1 px-sm-3 px-1 rounded">${messsageValue}</div>
                                        </div>
                                        <span class="ml-2 time">
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        resetEdit()
                        $("#message-info").hide()
                        $("#message-"+message_id).find(".s-msg").html(`<div class="py-1 px-sm-3 px-1 rounded">${messageText}</div>`)
                        // append(`<div id="message-${message.id}" class="d-flex flex-column justify-content-end text-right">
                        //             <div class="s-msg">
                        //                 <div class="py-1 px-sm-3 px-1 rounded">${message.message}</div>
                        //             </div>
                        ...
                        `);
                            ...
                            if (message.is_image == 0 && message.is_video == 0 && message.is_file == 0) {
                                ...
                                append(`<div id="message-${message.id}">
                                            <div class="r-msg">
                                                <div class="py-1 px-sm-3 px-1 rounded">${messageValue}</div>
                                            </div>
                                            <span class="ml-2 time">
                                            <span>
