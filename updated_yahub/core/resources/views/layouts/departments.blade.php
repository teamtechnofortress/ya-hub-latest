...
<head>
    ...
    @php 
        ...
        $user=\DB::table('departments')->where('created_by',Auth::user()->id)->where('active',1)->first();
...
<body>
    @if(Auth::user()->role == 2)
    <section> 
        @include('agency.partial.desktop-menu') 
        <div class="other-cont"> 
            @include('agency.partial.top-bar') 
            @include('messages') 
            @yield('content') 
        </div> 
    @include('agency.partial.mobile-menu') </section>
    @endif
    @if(Auth::user()->role == 4)
    
    <section> @include('lite-agency.partial.desktop-menu')
         <div class="other-cont"> @include('lite-agency.partial.top-bar') @include('messages') @yield('content') </div>
          @include('lite-agency.partial.mobile-menu') </section>
    @endif
