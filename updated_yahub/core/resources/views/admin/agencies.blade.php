                        ...
                        <tbody> @foreach($agencies as $user) <tr>
                                ...
                                <td> 
                                    @if($user->enable_invoiceTool==0) 
                                        <a href="{{url('/admin/agency/invoiceModule/'.$user->id.'/1')}}" class="btn btn-success btn-sm"><i class="fas fa-toggle-off"></i> Enable</a> 
                                    @endif @if($user->enable_invoiceTool==1) 
                                        <a href="{{url('/admin/agency/invoiceModule/'.$user->id.'/0')}}" class="btn btn-danger btn-sm"><i class="fas fa-toggle-on"></i> Disable</a> 
                                    @endif 
                                </td>
                                <td> 
