                    ...
                    action="{{url('projects/'.$project->id)}}"> @csrf @method('put') <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select name="user_id"
                                ...
                                <option value="0"
                                    @if(!empty($chat))
                                    @if($chat->client_id==0) selected @endif @else selected @endif>--SELECT CLIENT--</option> @foreach($users as $user) <option value="{{$user->id}}"
                                    @if(!empty($chat))
                                    @if($chat->client_id==$user->id) selected @endif @endif>{{$user->name}}</option> @endforeach
                            </select>
                        </div>
