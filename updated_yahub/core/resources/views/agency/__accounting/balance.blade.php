            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        ...
                        <input type="number" class="form-control task_title" name="task" id="task" placeholder="Enter Balance" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mt-4">
                ...
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        <label for="end_date">Credit / Debit</label>
                        <select name="status" id="status" class="form-control task_status">
                        <option value="usd" >Credit</option>
                        <option value="eur" >Debit</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6">
