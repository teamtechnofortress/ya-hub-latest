    ...
    <div class="py-4">
        <div class="row">
            ...
            <div class="col-lg-6 text-right">
                ...
                <a  href="#0" data-toggle="modal" data-target="#addTaskModal" class="btn btn-primary btn-sm add">Add Events +</a>
            </div>
        </div>
        <div class="col-md-12 task-form" style="display:none">
        <form action="{{ url('add_event') }}" method="post" id="form-task" data-action="">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        ...
                        <input type="text" name="event" id="contact" class="form-control contact_task_id" required />
                ...
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        ...
                        <input type="text" class="form-control task_title" name="location" id="task" placeholder="Enter location" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        <label for="contact">Date</label>
                        <input type="date" name="date" id="contact" class="form-control contact_task_id" required />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mt-4">
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-sm-12">
                <div class="table-responsive">
                    <table class="table table-stripped table-bordered" id="events_table" style="position: static;">
                        <thead>
                            <tr>
                            	@php
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                <form action="{{route('changeEventCurrency',$item->id)}}" method="POST" class="currencyForm">
                                   @csrf
                                ...
                                <td>
                                     <a href="{{ url('updateevent/' . $item->id) }}" class="btn btn-light btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="{{ url('deleteevent/'. $item->id) }}" class="btn btn-danger btn-sm deleteEvent">
   ...
   function initializeDataTableWithLogo(logoUrl) {
    ...
    $('#events_table').DataTable( {
        ...
        order: [[2, 'asc']], // Sort by the third column (index 2), which is the Date column
            columnDefs: [
                { targets: [0, 1, 3, 4, 5], orderable: true }, // Disable sorting for all columns except the Date column
            ]
