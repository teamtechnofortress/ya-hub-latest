...
<div class="p-sm-4 p-3 project">
    <div class="py-4">
        ...
        <div class="col-md-12 task-form" style="">
            <form action="{{url('saveupdateexpenses')}}" method="post" id="form-task" data-action="">
                @csrf
                ...
                <input type="hidden" class="task_id" name="id" value="{{ isset($data) ? $data->id : '' }}" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-4">
                            ...
                            <input type="text" name="expense" id="contact" class="form-control contact_task_id" required  value="{{ isset($data) ? $data->expense : '' }}" /> 
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mt-4 text-right">
                            <a href="{{url('expenses')}}" class="btn btn-light cancel">Cancel</a>
