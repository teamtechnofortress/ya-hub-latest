    ...
    <div class="py-4">
        ...
        <form action="{{url('add_payment')}}" method="post" id="form-task" data-action="">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group mt-4">
                        <label for="contact">Month/Year</label>
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-sm-12">
                <div class="table-responsive">
                    <table class="table table-stripped table-bordered" id="payment_table" style="position: static;">
                        <thead>
                            <tr>
                            	@php
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                <form action="{{route('changePaymentCurrency',$item->id)}}" method="POST" class="currencyForm">
                                   @csrf
                                ...
                                <td>
                                     <a href="{{ url('updatepayments/' . $item->id) }}" class="btn btn-light btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a> 
                                    <a href="{{ url('deletepayment/'. $item->id) }}" class="btn btn-danger btn-sm deletepayment">
