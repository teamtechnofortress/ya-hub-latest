 <div class="header border-bottom">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: transparent !important">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
                <a href="{{route('agency-dashboard')}}" class="btn n-project btn-sm"><i class="far fa-arrow-alt-circle-left"></i> Projects</a>
            </li>
            <li class="nav-item">
                <a href="{{route('agency-newproject')}}" class="btn n-project btn-sm">+ New Project</a>
            </li>
            @if(Auth::user()->enable_invoiceTool==1)
            <li class="nav-item">
                <a href="{{route('invoices')}}" class="btn btn-light btn-sm">Invoices</a>
            </li>
            <li class="nav-item">
                <a href="{{route('estimates')}}" class="btn btn-light btn-sm">Estimates</a>
            </li>
            <li class="nav-item">
                <a href="{{route('purchaseOrder')}}" class="btn btn-light btn-sm">Purchase Orders</a>
            </li>
            @endif
            @if(Auth::user()->departments==1)
            <li class="nav-item">
                <a href="{{route('departments')}}" class="btn btn-light btn-sm">Departments</a>
            </li>
            @endif
            @php 
