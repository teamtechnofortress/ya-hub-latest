            ...
            <div class="col-md-12 col-sm-12">
                        ...
                        <table class="myTable" style="margin-top: 10px !important;border: 0 !important;">
                            ...
                            <tbody id="items_tbl">
                                ...
                                <tr style="border: 0 !important;">
                                    ...
                                    <td style="border: 0 !important;text-align: center;padding:5px">{{$currency}} <span class="total_gross">{{$total_gross}}</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row mt-50">
                    <div class="col-lg-12 text-left">
                        ...
                        <div class="total">
                            <strong class="or">{{$lang=='fr' ? 'À payer' : 'Total Due'}}: {{$currency}} <strong class="or fw6 total_gross_c" style="font-size: 20px"> {{$total_gross}}</strong></strong>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 text-left">
                        <div class="total" style="margin-top: 50px !important;">
                            <strong class="or">{{$lang=='fr' ? 'Nom du vendeur' : "Buyer's signature"}}</strong><br>
