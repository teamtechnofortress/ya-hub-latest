                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="tel" name="phone2" id="phone2" class="form-control" placeholder="Second Phone" value="{{$contact->phone2}}">
                        </div>
                        <div class="form-group mt-2">
                            <label for="social" class="form-label">Social Link</label>
                            <input type="tel" name="social" id="social" class="form-control" placeholder="Social profile link" value="{{$contact->social}}">
                        </div>
                        <div class="form-group mt-2">
                        ...
                        <div class="form-group mt-2">
                            <label for="title" class="form-label">Title/Skills</label>
                            <input type="text" name="title" id="title" value="{{$contact->job_title}}" class="form-control" placeholder="Title/Skills">
                        </div>
                        <div class="form-group mt-2">
                            <label for="note" class="form-label">Notes</label>
                            <textarea name="note" id="note" class="form-control" placeholder="Notes">{!! $contact->note !!}</textarea>
                        </div>
