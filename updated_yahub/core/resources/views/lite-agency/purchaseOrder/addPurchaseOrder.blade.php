...
<div class="p-sm-4 p-3 project">
    <div class="py-4">
        <form action="{{route('addNewPurchaseOrder')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-6">
                        <input name="invoice_no" type="text" class="form-control" style="margin-bottom: 5px !important" value="" placeholder="Client Order No. XXX">
                        <textarea name="date_desc" class="form-control"></textarea>
                    </div>
                    </div>
                    <div class="row mt-100">
                        <div class="col-6">
                            <textarea name="info" class="form-control" rows="6"></textarea>
                        </div>
                        <div class="col-6">
                            <textarea name="info2" class="form-control" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="row mt-50">
                        <div class="col-12">
                    ...
                    <div class="row mt-50">
                        ...
                        <div class="col-lg-12 text-left">
                            <div class="total" style="margin-top: 50px !important;">
                                ...
                                <img src="{{$template[0]->seller_signature}}" alt="" id="signature" srcset="" width="100px">
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12 text-center">
                            <textarea name="footer" rows="3" cols="60" style="font-size:10px"></textarea>
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-12 text-right">
