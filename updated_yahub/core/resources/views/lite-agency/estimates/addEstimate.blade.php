...
<div class="p-sm-4 p-3 project">
    <div class="py-4">
        <form action="{{route('addNewEstimate')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-6">
                        <input name="invoice_no" type="text" class="form-control" style="margin-bottom: 5px !important" value="" placeholder="Estimate No. D/202211011">
