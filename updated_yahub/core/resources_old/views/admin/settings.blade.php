    ...
    <div class="py-4">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <form method="post"
                    action="{{url('admin/settings')}}"> @csrf<div class="row">
                        <div class="form-group col-md-12 py-2">
                            <strong>Settings</strong>
                        </div> @if(!empty($settings)) @foreach($settings as $setting) <div class="form-group col-md-12">
                            ...
                            <input type="text"
                                ...
                                value="{{$setting->value}}"
                                required />
                        </div> @endforeach @endif <div class="col-md-12 my-2">
                            <input type="submit"
                                name="submit"
