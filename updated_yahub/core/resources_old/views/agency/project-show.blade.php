                            ...
                            <td>
                                <div class="d-flex"
                                    ...
                                    <a href="{{url('projects/'.$project->id.'/edit/')}}"
                                        class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i> Edit</a> @if(!empty($project->chat)) <a href="{{url('chat/'.$project->chat->id)}}"
                                        class="btn btn-sm btn-primary"><i class="fa fa-comment"></i> Chat</a> @endif
                                </div>
                            </td>
                        </tr>
                        <tr>
