    ...
    <div class="py-4">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <form method="post"
                    action="{{url('lite-agency/profile/update')}}" enctype="multipart/form-data"> @csrf<div class="row">
                        ...
                        <div class="col-md-12 my-2">
                            <input type="submit"
                                ...
                                class="btn n-project" />
                            <a href="{{route('lite-agency-deleteAccount')}}"
                                class="btn bg-danger deleteAccount btn-sm"><i class="far fa-trash-alt"></i> Delete Account</a>
                            <a href="#0" id="copy_link" data-clipboard-target="#content" class="btn btn-info btn-sm">Copy Link <i class="fa fa-copy"></i></a>
                            <p style="color:white" id="content">https://ya-hub.com/app/register</p>
                        </div>
                    </div>
                </form>
            </div>
