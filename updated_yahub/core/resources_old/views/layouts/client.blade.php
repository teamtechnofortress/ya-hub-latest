...
<body>
    <section> @include('client.partial.desktop-menu') <div class="other-cont"> @include('client.partial.top-bar') @include('messages') @yield('content') </div> @include('client.partial.mobile-menu') </section>
